<template>
  <div class="card" @click="$emit('click')">
    ...
    <div class="body">
      <div class="top-title">Recipe of the Day</div>
      <div class="title">{{ title }}</div>
      <Ratings
        v-bind:rating="rating"
        v-bind:ratingsCount="ratingsCount"
        v-bind:showedRatingsCount="false"
      />
      <div class="break" />
      <div class="details">
        <Durations v-bind:showedIcon="false" v-bind:minutes="durationsInMinutes" />
        <Energy v-bind:showedIcon="false" v-bind:value="energyValue" v-bind:units="energyUnit" />
